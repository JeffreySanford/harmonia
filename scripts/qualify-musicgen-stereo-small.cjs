...
async function main() {
  ...
  console.log('============================================================');
  console.log(' MUSICGEN STEREO SMALL PRODUCT QUALIFICATION');
  console.log('============================================================');
  ...
  const created = await request(`${backendBase}/api/jobs`, {
    ...
    body: JSON.stringify({
      ...
      parameters: {
        title: 'Harmonia MusicGen Stereo Small Qualification',
        prompt:
  ...
  if (wav.channels !== 2) {
    throw new Error(
      `Expected stereo output with 2 channels, received ${wav.channels}`
    );
  }
  ...
  console.log('');
  console.log('============================================================');
  console.log(' MUSICGEN STEREO SMALL QUALIFICATION PASSED');
  console.log('============================================================');
  ...
  console.log('MUSICGEN_STEREO_SMALL_QUALIFICATION_OK');
}

main().catch((error) => {
  console.error('');
  console.error('MUSICGEN_STEREO_SMALL_QUALIFICATION_FAILED');
